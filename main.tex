...
The choice of machine learning was inspired by research, the papers we found most helful were [Reference the 2 papers i asked lewis to add]. The decision was then reinforced by an taking into account that decision trees of such depth require very little computational time and power and are easier to implement that other methods, such as neural networks and  
