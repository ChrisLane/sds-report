...
The research methods we used include a questionnaire, installing and using manufacturers apps on our mobile devices, browsing their websites and several searches on search engines.
	\begin{itemize}
