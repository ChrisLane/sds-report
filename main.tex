...
\subsection{General}
Our system consists of many components, these are the centre console, the instrument cluster, rear back door screens, and a navigation screen. There is also of course the phone application which will be installed on user mobile devices.

The centre console will be 10" screen located in the front of the car on the dash between the front two seats of the car. This centre console is the central computing unit for the car and has an android operating system. This will have a dual system architecture. The reason for this is because both systems will be flashed with the same image before a software update. This will allow one of the systems to be written with the new system image and have the previous image as bootable backup in case the new system is corrupted.

The instrument cluster, rear back door screens and navigation screen are connected to the centre console via a network of serial cables. Data is sent between these devices. It consists of data for the console to process and what to display on the devices screens.
...
%% NEED TO MENTION HOW PHONE TELLS CAR 
...
Figure~\ref{qoc-map} asks how the map can be displayed on the navigation screen. 
