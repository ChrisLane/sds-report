...
If music is from spotify, then associated actions for controlling the spotify account logged in on the centre console are embedded within the message.
The centre console of the car also has a spotify account logged in, 
