...
Our dashboard can contain widgets to display simple information like weather which would be updated regularly.
...
\begin{itemize}
  \item Data base
  \item 
  \item Communication -- mentioned in above section
\end{itemize}
% Repeating what is said in communication (2.4) ^^

\subsection{Design choices \& argumentation --- (not) Lewis}\label{ssec:app-design}
