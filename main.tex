...
conclude that "the driver's attention to the road and traffic is likely to be compromised" when HUD information is shown on the windshield. After some internal discussions we also feel that: 
