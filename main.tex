...
We had a lot of ideas surrounding the convoy functionality, so we created a Lo-Fi design to see how some of our ideas might look. Figure~\ref{convoy-lofi} presents a convoy with four drivers, 
...
These designs follow the design choices we came to a conclusion to in the previous section. In the home screen (left most image of Figure \ref{figure-app-lofi}) we have large buttons paired with labels giving a brief description of what the buttons do.  
