...
\subsection{General}
Our system consists of many components, these are the centre console, the dashboard, rear back door screens, and a navigation screen. And of course the phone application which will be installed on user mobile devices.
...
%
% Have we mentioned the existence of this?
%
in the car; a touchscreen keyboard which is displayed on the centre console; or via the phone app, which is explained further in 
