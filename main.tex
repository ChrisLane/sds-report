...
The choice of machine learning was inspired by research, the papers we found most helpful were inspired by research [Reference the 2 papers i asked lewis to add]. The decision was then reinforced by the observations that decision trees of such depth require very little computational time and power and are easier to implement that other methods, such as neural networks, ensemble and matrix factorisation-based methods.
